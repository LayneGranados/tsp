...
public class HistoricoVersion {
    ...
    public HistoricoVersion() {
    }

    public HistoricoVersion(int version, String fecha, String usuario, String razonComentario, int locAdicionados, int locEliminados, int locModificados, int locTotales) {
    ...
    public HistoricoVersion(String linea) {
